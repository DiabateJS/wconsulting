...
try {
    ...
    $mail->addReplyTo('contact@wonder-consultingrh.com', 'Wonder consulting RH');
    ...
    $mail->Body    = '<b>Bonjour!</b>
                <br><br>Nous accusons réception de votre besoin et vous remercions pour votre intérêt concernant notre société. Nous revenons vers vous dans un délai de 48H.
                <br><br>A très bientôt !
                <br><br><br><br>L’équipe Wonder Consulting RH ';
                $mail->send();
    ...
    echo "<div class='alert alert-success' role='alert'>Message could not be sent. Mailer Error: {$mail->ErrorInfo}</div>";
}
