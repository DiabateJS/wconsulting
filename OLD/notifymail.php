...
try {
    ...
    $mail->addAddress($_POST['email'],'Wonder Consulting RH');     // Add a recipient
    ...
    $mail->Body    = '<b>Bonjour!</b>
                <br><br>Nous accusons réception de votre message et vous remercions pour votre intérêt concernant notre société. Nous revenons vers vous dans un délai de 48H.
  ...
  <strong>Envoyé!</strong> Votre message n\'a pas été envoyer suite à une erreur. Veuillez réessayer plutard.
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';*/
}
