...
function GetSFrancList()
{
    ...
    try
    {
        ...
        $stmt = $pdo->query("SELECT * FROM s_franc " );
                ...
                {  
                   ...
                   echo "  
                    <tr>
                        ...
                        <td>".  $message->Type_SF ."</td>
                        <td>".  $message->Date_SF ."</td>
                        <td>".  $message->Montant_SF ." "."FC"."</td>
                        <td>".  $message->Description_SF ."</td>
