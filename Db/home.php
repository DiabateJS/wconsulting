                ...
                {  
                   ...
                   echo "  
                    <tr>
                        ...
                        <td>".  $message->Nom_de_la_tache ."</td>
                        <td>".  $message->Nom_agent ."</td>
                        <td>".  $message->Date_tache ."</td>
                        <td><span class='label label-primary'>".  $message->Etat ."</span><a href='index.php?Module=Affectation&Action=Update_Tache&id=".  $message->id_tache ."'><i class='fa fa-edit'> Update status</i></a></td> 
                        <td>".  $message->Description_tache ."</td>
                        
                        <td><a href='index.php?Module=Affectation&Action=Delete&id=".  $message->id_tache ."'><i class='fa fa-trash-o'> Delete tâche</i></a></td>
