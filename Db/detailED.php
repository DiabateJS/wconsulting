...
function GetEDollarsList()
{
    ...
    try
    {
        ...
        $stmt = $pdo->query("SELECT * FROM e_dollars " );
                ...
                {  
                   ...
                   echo "  
                    <tr>
                        ...
                        <td>".  $message->Type_ED ."</td>
                        <td>".  $message->Date_ED ."</td>
                        <td>".  $message->Montant_ED ." "."$"."</td>
                        <td>".  $message->Description_ED ."</td>
